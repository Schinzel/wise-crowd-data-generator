...
class ActivityLevelTest {
    ...
    fun constructor_longDescription_succeeds() {
        val longDescription =
            "This is a very long description that explains the activity level in great detail and provides comprehensive information about the trading frequency and behavior patterns"
        val activityLevel =
            ActivityLevel(
                id = 1,
                name = "Inactive",
