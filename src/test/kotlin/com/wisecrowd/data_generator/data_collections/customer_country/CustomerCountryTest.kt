...
class CustomerCountryTest {
    ...
    fun constructor_validInputs_setsId() {
        val customerCountry = CustomerCountry(
            id = 1,
            name = "Sweden",
            countryCode = "SE",
    ...
    fun constructor_longDescription_succeeds() {
        val longDescription = "This is a very long description that explains the customer country in great detail and provides comprehensive information about the market characteristics and customer behavior patterns"
        val customerCountry = CustomerCountry(
            id = 1,
            name = "Sweden",
            countryCode = "SE",
