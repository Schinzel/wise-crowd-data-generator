...
class TransactionGenerator(
    ...
    fun generateTransactionsForUser(
        ...
        val actualDepartureDate =
            if (userData.customerStatus == CustomerStatus.ACTIVE) {
                null
            } else {
        ...
        if (userData.customerStatus == CustomerStatus.DEPARTED && actualDepartureDate != null) {
            val sellOffTransactions =
                generateSellOffTransactions(
                    userData.userId,
                    actualDepartureDate,
                    assetPriceCollection,
                    userCurrencySelector,
    ...
    private fun generateRegularTransactions(
        ...
        return (0 until periodTransactionCount).mapNotNull {
            generateSingleRegularTransaction(
                userId,
                startDate,
                effectiveEndDate,
                assetPriceCollection,
    ...
    private fun generateSingleRegularTransaction(
        ...
        val price =
            assetPriceCollection.getPriceOnDate(assetId, transactionDate)
                ?: return null
