...
Create PriceSeriesDataGenerator that implements IDataGenerator to generate historical price data using MarketTrendCollection and Asset Generator output.
